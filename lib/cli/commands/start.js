...
let configPath = config = null;
try {
    configPath = require.resolve("../../../config");
    config = require(configPath);
} catch(e) {
    console.log(chalk.red('❌ config.js is not found.'));
    console.log(chalk.cyan('Please duplicate example.config.js and rename it to config.js\n'));
    process.exit(e.code);
}
